...
Util.storyCate = ["truyện teen", "ngôn tình", "truyện ma", "trinh thám", "văn học việt nam", "văn học phương tây", "tiểu thuyết tình yêu", "viễn tưởng - siêu nhiên", "thể loại khác", "văn học nhật bản"];
Util.accessable = [
  "Tạo/Xoá Admin",
  "Tạo/Xoá Sách Truyện",
  "Tạo/Xoá Truyện Tranh",
  "Tạo/Xoá Radio Truyện "
];
