...
GameData.ships = [
  {'id': 0, 'name': 'marine', 'hp': 1000, 'weaponAttSLot': 3, 'weaponDefSlot': 3, 'upgrade': 0},
  {'id': 5, 'name': 'blackPear', 'hp': 4000, 'weaponAttSLot': 4, 'weaponDefSlot': 4, 'upgrade': 0},
  {'id': 10, 'name': 'thunder', 'hp': 2000, 'weaponAttSLot': 4, 'weaponDefSlot': 4, 'upgrade': 0}
];
